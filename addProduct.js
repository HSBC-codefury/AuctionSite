window.addEventListener('load',function()
{
    ...
    document.querySelector("#addproductform > div > div > button").addEventListener('click',
        function()
        {
            ...
            //
            // }
            var check = document.getElementById('quantity').value;
            console.log(check);
            if(check < 1)
            {
                alert("There should be atleast one quantity");
